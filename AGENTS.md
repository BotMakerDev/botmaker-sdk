...
`../botmaker-studio-api/AGENTS.md`, which records the reversal from the contract's side.
...
`../botmaker-shared/AGENTS.md` for the backend selection (`RobotCapture` vs `SpectacleCapture`) and the
Wayland notes.
