 ...
 * exists. It replaces the top bar's bare name field, which could only ever produce an activity with no
 * outcomes — leaving the user to discover the side panel before their card had anything but a NEXT port to
 * wire from.
 *
...
public final class NewActivityDialog {
    ...
    /**
     * Shows the dialog and blocks until it closes. Returns the new activity, placed at {@code (x, y)}, or
