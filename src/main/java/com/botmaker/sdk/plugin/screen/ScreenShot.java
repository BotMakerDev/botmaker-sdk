 ...
 *
 * <p>A {@link ShotSource} produces one and {@link ScreenOverlay} consumes one knowing nothing about where it
 * came from. That is the whole split: everything downstream of this record — the rubber-band surfaces, the
 * magnifier, the screen chooser, the crop arithmetic — names no capture target at all, which is what let the
 * two halves of capture move out of the editor separately.
 *
